    ...
    <main className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Revisa tu email — te enviamos los detalles.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-slate-900">{reserva.servicio?.nombre}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-indigo-100 rounded-lg flex items-center justify-center shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-slate-400">Confirmación enviada a</p>
              <p className="font-semibold text-slate-900">{reserva.cliente_email}</p>
            </div>
          </div>
        </div>

        <div className="mt-4 p-4 bg-indigo-50 rounded-xl text-sm text-indigo-700 text-center">
          Código de reserva: <span className="font-mono font-bold">{id.slice(0, 8).toUpperCase()}</span>
        </div>

        <Link href="/" className="mt-6 block text-center text-slate-500 hover:text-indigo-600 transition text-sm">
          ← Volver al inicio
        </Link>
      </div>
    </main>
